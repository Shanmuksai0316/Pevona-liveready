...
export default function MaintenanceRepairPage() {
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="max-w-[1560px] mx-auto px-6 lg:px-[120px] mt-[150px] flex flex-col lg:flex-row items-center gap-[80px]">
      ...
      <section className="max-w-[1560px] mx-auto px-6 lg:px-[118px] mt-[160px] flex flex-col gap-[80px]">
      ...
      <section className="max-w-[1560px] mx-auto px-6 lg:px-[98px] mt-[160px]">
      ...
      <section className="max-w-[1560px] mx-auto px-6 lg:px-[120px] mt-[160px] mb-[140px] flex flex-col lg:flex-row items-center gap-[80px]">
        <div className="flex-1 relative w-full max-w-[640px] h-[460px] rounded-[26px] overflow-hidden">
          <Image
