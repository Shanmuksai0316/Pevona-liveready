...
export default function HMOPage() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      {/* What is an HMO */}
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[60px] mt-[150px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px]">
      ...
      {/* HMO Services */}
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[60px] mt-[80px]">
      ...
      {/* HMO Requirements */}
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[60px] mt-[140px] mb-[120px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px]">
