  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 lg:px-[60px] xl:px-[80px] pt-[100px] sm:pt-[120px] md:pt-[150px]">
        ...
        <p className="font-manrope text-[14px] sm:text-[16px] text-gray-600 mb-8 sm:mb-10 md:mb-12">Last Updated: September 2025</p>
        
        <div className="prose prose-lg max-w-none">
          <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700 mb-12">
            This Cookie Policy explains how Pevona Ltd uses cookies and similar technologies to
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
              ...
              'essential' or 'strictly necessary' cookies. Other cookies also enable us to track and target
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
              <li><strong>Essential website cookies:</strong> These cookies are strictly necessary to provide you with
                services available through our website.</li>
              <li><strong>Performance and functionality cookies:</strong> These cookies are used to enhance the
                performance and functionality of our website.</li>
              <li><strong>Analytics and customization cookies:</strong> These cookies collect information that is used
                either in aggregate form to help us understand how our website is being used or how
                effective our marketing campaigns are.</li>
              <li><strong>Social networking cookies:</strong> These cookies are used to enable you to share pages and
                content that you find interesting on our website through third-party social networking
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
              We use Google Analytics to collect information about how visitors use our website. This
              information is used to compile reports and to help us improve the website. The cookies
              collect information in an anonymous form, including the number of visitors to the
              website, where visitors have come to the website from, and the pages they visited.
            </p>
          </section>
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
              You have the right to decide whether to accept or reject cookies. You can set your web
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
              ...
              us at <a href="mailto:admin-pev@pevonaltd.co.uk" className="text-[#0073B5] hover:underline">admin-pev@pevonaltd.co.uk</a>.
            </p>
          </section>
          ...
          <section className="mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="bg-[#FCE6E9] border-l-4 border-[#002f57] p-4 rounded">
              <p className="font-manrope text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-gray-700">
                ...
                advertising. By continuing to use our site, you accept our use of cookies. To learn more,
