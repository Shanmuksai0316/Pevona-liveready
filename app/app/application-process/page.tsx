...
export default function ApplicationProcessPage() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="max-w-full mx-[60px] 1400:max-w-[1336px] 1400:mx-auto 1920:max-w-[1600px] 1600:max-w-[1330px] px-6 lg:px-0 mt-[80px] flex flex-col lg:flex-row gap-[60px] items-start">
      ...
      <section className="max-w-full mx-[60px] 1400:max-w-[1336px] 1400:mx-auto 1920:max-w-[1600px] 1600:max-w-[1330px] px-6 lg:px-0 mt-[120px] mb-[60px] lg:mb-[140px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px] lg:pl-[60px]">
