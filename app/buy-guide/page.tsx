  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative max-w-[1560px] mx-auto px-6 lg:px-[130px] pt-10 pb-[80px]">
      ...
      <section className="max-w-[1320px] mx-auto px-4 lg:px-0 lg:pl-[80px] lg:pr-[40px] mt-[120px] flex flex-col lg:flex-row gap-[48px] items-start">
        {/* Left: intro + image */}
      ...
      {/* How we help section */}
      <section className="max-w-[1320px] mx-auto px-4 lg:px-[80px] mt-[140px] flex flex-col lg:flex-row items-center gap-[70px]">
      ...
      <section className="mt-[160px] w-full bg-[#002f57] py-[80px]">
        <div className="max-w-[1320px] mx-auto px-4 lg:px-[80px] text-white space-y-10">
      ...
      <section className="max-w-[1560px] mx-auto px-4 lg:px-[40px] mt-[120px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="relative flex-1 min-h-[360px] rounded-[24px] overflow-hidden">
          <Image
            src="/images/buy-guide/birmingham.png"
      ...
      <section className="max-w-[1560px] mx-auto px-4 lg:px-[40px] mt-[140px] mb-[120px] flex flex-col lg:flex-row items-center gap-[70px]">
