...
export default function LandlordServicesPage() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      {/* Our Letting Process */}
      <section className="max-w-[1316px] mx-auto px-6 lg:px-[40px] mt-[140px] flex flex-col lg:flex-row gap-[70px] items-center">
      ...
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[40px] mt-[140px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px] lg:pl-[60px]">
      ...
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[80px] mt-[80px] mb-[120px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px] lg:pr-[60px]">
