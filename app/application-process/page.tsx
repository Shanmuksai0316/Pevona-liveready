...
export default function ApplicationProcessPage() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[40px] mt-[80px] flex flex-col lg:flex-row gap-[60px] items-start">
      ...
      {/* Required Documents */}
      <section className="max-w-[1320px] mx-auto px-6 lg:px-[80px] mt-[120px] flex flex-col gap-[26px]">
        <h2 className="font-crimson text-[40px] md:text-[56px] leading-[56px] tracking-[-1.68px] text-[#002f57]">
          Required Documents
        </h2>
      ...
      <section className="max-w-[1336px] mx-auto px-6 lg:px-[40px] mt-[120px] mb-[140px] flex flex-col lg:flex-row gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px] py-[40px] lg:py-[60px] lg:pl-[60px]">
