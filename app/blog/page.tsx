...
export default async function BlogPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Header Section */}
      <section className="max-w-[1336px] mx-auto px-5 350:px-5 480:px-5 650:px-[60px] lg:px-[80px] 1300:px-[80px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] pt-[150px] pb-[60px] sm:pb-[80px] md:pb-[100px]">
      ...
      {latestBlog && (
        <section className="max-w-[1336px] mx-auto px-5 350:px-5 480:px-5 650:px-[60px] lg:px-[80px] 1300:px-[80px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] mb-[60px] sm:mb-[80px]">
