...
export default async function BlogPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Header Section */}
      <section className="max-w-full mx-[60px] 1400:max-w-[1336px] 1400:mx-auto 1920:max-w-[1600px] 1600:max-w-[1330px] px-5 350:px-5 480:px-5 650:px-[60px] lg:px-[40px] 1100:px-[80px] 1300:px-[80px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] pt-[150px] pb-[60px] sm:pb-[80px] md:pb-[100px]">
