  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="max-w-[1600px] mx-auto px-5 350:px-5 480:px-5 650:px-[60px] lg:px-[40px] 1100:px-[80px] 1300:px-[80px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] mt-[60px] 650:mt-[80px] lg:mt-[100px] 1500:mt-[130px] 1600:mt-[150px] flex flex-col gap-[36px] items-center">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center h-[48px] px-5 rounded-[8px] bg-[#002f57] text-white font-manrope font-semibold text-[18px] leading-[28px] hover:bg-[#001f3a] transition-colors mt-8"
        >
      ...
      <section className="max-w-full mx-[20px] md:mx-[60px] 1400:max-w-[1336px] 1400:mx-auto 1920:max-w-[1600px] mt-[60px] 650:mt-[80px] lg:mt-[100px] 1500:mt-[130px] 1600:mt-[150px] mb-[60px] lg:mb-[120px] flex flex-col lg:flex-row gap-[26px] lg:gap-[78px] items-center bg-white border border-[rgba(0,0,0,0.12)] rounded-[26px]">
        <div className="w-full lg:w-[40%] relative h-[450px] rounded-[26px] overflow-hidden order-2 lg:order-1">
          <Image
        ...
        <div className="w-full lg:w-[60%] space-y-[12px] order-1 lg:order-2 p-[5%] lg:p-0">
