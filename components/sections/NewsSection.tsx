    ...
    <div className="flex flex-col gap-[26px] items-start px-5 350:px-5 480:px-5 650:px-[60px] lg:px-[80px] 1300:px-[80px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] w-full mt-[60px] 650:mt-[80px] lg:mt-[100px] 1500:mt-[130px] 1600:mt-[150px]">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-[26px] items-stretch lg:items-center justify-center w-full">
        ...
        <div className="w-full lg:flex-1 bg-white border border-[rgba(0,0,0,0.12)] flex flex-col gap-4 sm:gap-6 lg:gap-[26px] items-center p-3 sm:p-4 lg:p-[5px] rounded-[12px] sm:rounded-[16px]">
          <div className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] lg:h-[465px] rounded-[10px] sm:rounded-[12px] overflow-hidden">
            <Image
          ...
          <div className="flex flex-col gap-4 sm:gap-6 lg:gap-[26px] items-start w-full px-2 sm:px-0">
            <div className="flex flex-col items-start">
              <h4 className="font-crimson font-semibold text-[20px] sm:text-[22px] md:text-[26px] leading-[26px] sm:leading-[28px] md:leading-[30px] text-[#002f57] max-w-full lg:max-w-[322px]">Invest Smart, Live Better</h4>
        ...
        <div className="w-full lg:flex-1 flex flex-col">
          {[
            ...
            <div key={i} className={`border-b border-[rgba(51,51,51,0.6)] flex flex-col sm:flex-row gap-3 sm:gap-[16px] items-start sm:items-center ${i === 0 ? 'pb-4 sm:pb-[26px]' : 'py-4 sm:py-[26px]'}`}>
              ...
              <h4 className="flex-1 font-crimson font-semibold text-[16px] sm:text-[18px] md:text-[20px] leading-[22px] sm:leading-[26px] md:leading-[30px] text-[#333333]">{item.title}</h4>
            </div>
          ))}
        </div>
      </div>
